  ...
  return (
    <div className="w-full max-w-4xl mx-auto p-4 space-y-4">
      ...
      >
        ...
        <Upload className={`h-10 w-10 mb-4 ${isDragging ? 'text-tattoo-red' : 'text-tattoo-white/50'}`} />
      ...
      {previews.length > 0 && (
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3 mt-4">
          {previews.map((preview, index) => (
            <div key={index} className="relative group rounded-md overflow-hidden border border-tattoo-white/10 hover:border-tattoo-white/30 transition-colors">

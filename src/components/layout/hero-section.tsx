      ...
      <div className='container max-w-6xl mx-auto px-4 md:px-6 relative z-10 py-20 md:py-32'>
        <div className='max-w-3xl'>
          ...
          <p className='text-xl text-tattoo-white/90 mb-8 leading-relaxed'>
            Professional custom tattoos that tell your unique story. Experience the perfect blend of
            artistry and precision.
          </p>

          <div className='flex flex-col sm:flex-row gap-4'>
            <Link href='/booking' className='tattoo-button group'>
              Book Your Session
              <ArrowRight className='h-4 w-4 ml-1 group-hover:translate-x-1 transition-transform' />
            </Link>

            <Link href='/gallery' className='tattoo-button-outline'>
              Explore Our Work
            </Link>
          </div>
          ...
          <div className='mt-16 grid grid-cols-2 md:grid-cols-4 gap-6'>
            {[
              ...
              <div key={index} className='text-center'>
                <div className='text-3xl md:text-4xl font-bold text-tattoo-red mb-1'>
                  {stat.number}
                </div>

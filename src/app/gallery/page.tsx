          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="rounded-lg overflow-hidden">
              ...
              <div className="bg-tattoo-blue p-4 text-left">
                ...
                <p className="text-white/70 text-sm">Creating clean, consistent lines requires steady hands and years of practice</p>
              </div>
            </div>
            ...
            <div className="rounded-lg overflow-hidden">
              ...
              <div className="bg-tattoo-blue p-4 text-left">
                ...
                <p className="text-white/70 text-sm">Watch how we create smooth color transitions and vibrant designs</p>
              </div>
            </div>
            ...
            <div className="rounded-lg overflow-hidden">
              ...
              <div className="bg-tattoo-blue p-4 text-left">
                ...
                <p className="text-white/70 text-sm">The art of creating depth and dimension through various shading methods</p>
              </div>
            </div>
          </div>
        </div>

    ...
    <main className='bg-tattoo-black min-h-screen pb-16'>
          ...
          {artists.map((artist, index) => (
            ...
            >
              ...
              <div className='md:w-2/3 space-y-6'>
                ...
                <p className='text-tattoo-white/80'>{artist.bio}</p>
                ...
                <div className='flex flex-wrap gap-4'>
                  ...
                  <Button
                    asChild
                    variant='outline'
                    className='border-tattoo-white/20 text-tattoo-white hover:bg-tattoo-white/10'
                  >
      ...
      <div className='container mx-auto px-4 md:px-6 mt-24'>
        <div className='bg-tattoo-blue p-8 md:p-12 rounded-lg text-center'>
          <h2 className='text-3xl font-bold text-tattoo-white mb-4'>Can't Decide Which Artist?</h2>
          <p className='text-tattoo-white/90 max-w-2xl mx-auto mb-8'>
            Submit your tattoo idea through our contact form, and we'll match you with the best
            artist for your style.
          </p>
          <Button
            asChild
            size='lg'
            className='bg-tattoo-white text-tattoo-blue hover:bg-tattoo-white/90'
          >

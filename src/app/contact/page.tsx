...
export const metadata: Metadata = {
  ...
  description:
    'Get in touch with Fernando Govea to discuss your tattoo ideas or book an appointment.',
}
              ...
              <div className='space-y-4'>
                <div>
                  ...
                  <p className='text-sm text-tattoo-white/70 mt-1'>
                    Tattoo prices vary based on size, detail, and placement. I provide custom quotes
                    after reviewing your design idea.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className='text-sm text-tattoo-white/70 mt-1'>
                    Yes, I work by appointment only to ensure each client receives my full attention
                    and the best possible results.
                  </p>
                </div>

                <div>
                  <h3 className='font-medium text-tattoo-red'>
                    What if I don't have a design yet?
                  </h3>
                  <p className='text-sm text-tattoo-white/70 mt-1'>
                    I can help create a custom design based on your ideas. Just share your concept
                    and we'll work together to bring it to life.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className='text-sm text-tattoo-white/70 mt-1'>
                    Yes, I require a non-refundable deposit to secure your appointment, which is
                    then applied to your final tattoo cost.
                  </p>
                </div>
              </div>
            </div>
